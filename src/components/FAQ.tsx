        ...
        <section id="faq" className="py-10 px-10 lg:px-20 lg:py-20">
            <div className="flex flex-col lg:flex-row gap-10">
                ...
                >
                    ...
                    <a href="mailto:info@makemytravls.com" className="mt-3 block text-xl lg:text-4xl text-secondary font-semibold hover:underline text-center lg:text-left">info@makemytravls.com</a>
                </motion.div>
